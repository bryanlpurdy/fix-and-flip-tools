...
- **Net Sheet date input text-align** — `.detail-row input[type="date"] { text-align: left }` ensures the date field aligns left with other inputs. Without this, some browsers center date inputs by default.
